    ...
    with open("./proxies/working.csv", "r") as f:
        ...
        readme = readme.replace("#var-working", f"{all}").replace("#var-http", f"{nhttp}").replace("#var-socks4",
            ...
            "#var-socks5", f"{nsocks5}").replace("#var-ultrafast", f"{nultrafast}").replace("#var-fast",
                                                                                            f"{nfast}").replace(
            "#var-medium", f"{nmedium}").replace("#var-slow", f"{nslow}").replace("#var-ultraslow",
                                                                                  f"{nultraslow}").replace(
            "#var-excluded", f"{nexcluded}").replace("#var-misconfigured", f"{nmisconfigured}")
        with open("./README.md", "w") as f:
            f.write(readme)
